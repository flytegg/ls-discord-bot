...
import com.learnspigot.bot.database.counting.Counting
...
object Mongo {
    ...
    val countingCollection: MongoCollection<Counting> = database.getCollection("counting", Counting::class.java)
